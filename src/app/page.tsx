    ...
    <main className="bg-black bg-cover min-h-screen text-white font-[Courier] flex flex-col justify-between">
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="p-5 flex flex-col items-center lg:items-start">
          <img src="profile.jpg" className="w-32 sm:w-40 rounded-full" alt="Profile Picture" />
          ...
          <div className="flex gap-4 pb-1 text-lg">
            ...
            <Link href="https://x.com/_afinikiii/status/1500443043471708161?s=46&t=oPa8HQe6M3XL102cO7SF7w" target="_blank">
              <FaTwitter />
            </Link>
            <Link href="https://www.linkedin.com/in/afiniki-john-52bab7212/" target="_blank">
              <IoLogoLinkedin />
            </Link>
          </div>
        ...
        <div className="w-full lg:w-3/4 mt-8 lg:mt-0">
          <div className="h-[max(80dvh,30rem)] relative -top-48">
            <Slider />
      ...
      {/* WHITE BACKGROUND */}
      <div className="w-full bg-gray-500 py-10 rounded-tr-[3rem] rounded-tl-[3rem] -top-96">
        <div className="container mx-auto px-4 text-black text-center">
          <p>Inspired by <span className="text-gray-800">Prince Charles</span></p>
        </div>
      </div>
    </main>
  );
